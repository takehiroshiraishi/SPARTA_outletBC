...
#include "math.h"
#include "surf_collide_outlet_v.h"
#include "surf.h"
...
SurfCollideOutletV::~SurfCollideOutletV()
{
  if (copy) return;
...
Particle::OnePart *SurfCollideOutletV::
        ...
        int isurf, double *norm, int isr, int &reaction)
{
  ...
  double u0dottan = vx*tangent1[0] + vy*tangent1[1] + vz*tangent1[2];
